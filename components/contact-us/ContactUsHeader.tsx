...
export const ContactUsHeader: React.FC = () => {
  return (
    <div className="max-w-[470px] md:max-w-[720px] mx-auto px-4 md:px-0 my-2 md:mt-2 md:mb-12 text-center font-sans">
      <h1 className="font-extrabold text-[32px] leading-[40px] sm:text-[42px] sm:leading-[48px] md:text-[48px] md:leading-[56px] xl:text-[56px] xl:leading-[64px] text-[var(--brand-deep)] mb-2 md:mb-4">
