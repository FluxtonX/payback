...
export const ScamHero: React.FC<ScamHeroProps> = ({ scamType, title }) => {
  ...
  return (
    <section className="relative bg-[var(--brand-primary)] text-[#f4f4f4] pt-8 pb-10 sm:pt-10 sm:pb-12 xl:pt-12 xl:pb-14 font-sans">
      <div className="container max-w-[1208px] mx-auto px-4 flex flex-col items-center text-center">
        ...
        <form onSubmit={handleSubmit} className="w-full max-w-[376px] flex flex-col gap-4">
          ...
          <button
            type="submit"
            className="w-full h-[52px] bg-[#ffd700] hover:bg-[#ffe661] text-[var(--brand-primary)] font-bold text-[16px] transition-colors rounded-none flex items-center justify-center"
          >
