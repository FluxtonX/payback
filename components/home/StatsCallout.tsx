...
export const StatsCallout: React.FC = () => {
  return (
    <aside className="bg-[var(--brand-primary)] py-12 lg:py-16 font-sans">
      <div className="container max-w-[1208px] mx-auto px-4 flex flex-col xl:flex-row justify-center items-center gap-8 xl:gap-10">
        ...
        <div className="flex flex-col items-center xl:items-start text-center xl:text-left xl:w-[480px]">
          ...
          <p className="text-[15px] sm:text-[16px] text-[var(--brand-soft)] leading-[26px] mb-6 max-w-[584px]">
          ...
          <Link
            href="/contact-us/"
            className="inline-block py-3 px-8 bg-[#ffd700] text-[var(--brand-primary)] font-semibold text-[16px] hover:bg-[#ffe661] hover:border-[#ffe661] transition-colors border border-[#ffd700] text-center w-full sm:w-auto"
          >
