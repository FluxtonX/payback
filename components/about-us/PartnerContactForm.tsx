        ...
        <div className="bg-white shadow-[8px_16px_32px_0_rgba(3,14,49,0.08)] py-8 px-4 sm:py-12 sm:px-8 md:py-12 md:px-16 xl:py-12 xl:px-24 max-w-[1000px] mx-auto flex flex-col items-center">
          {submitted ? (
            <div className="py-12 text-center max-w-[376px] mx-auto">
              ...
              <h3 className="text-[20px] font-bold text-[var(--brand-deep)] mb-2">Thank you!</h3>
                ...
                <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                  ...
                  <div className="relative">
                    <input
                      ...
                      required
                      className="w-full bg-[#f4f4f4] border border-[#f4f4f4] focus:border-[var(--brand-primary)] focus:bg-white px-4 py-3.5 text-[15px] sm:text-[16px] text-[var(--brand-deep)] placeholder-[#616267] outline-none transition-colors"
                    />
                  </div>
                  ...
                  <div className="md:col-span-2">
                    <textarea
                      ...
                      className="w-full bg-[#f4f4f4] border border-[#f4f4f4] focus:border-[var(--brand-primary)] focus:bg-white px-4 py-3.5 text-[15px] sm:text-[16px] text-[var(--brand-deep)] placeholder-[#616267] outline-none transition-colors h-[140px] resize-none"
                    />
                  </div>
                  ...
                  <div className="md:col-span-2 flex justify-center mt-2">
                    <button
                      type="submit"
                      className="w-full sm:w-[376px] py-3.5 bg-[#ffd700] text-[var(--brand-primary)] font-semibold text-[16px] hover:bg-[#ffe661] hover:border-[#ffe661] transition-colors border border-[#ffd700] text-center cursor-pointer select-none"
                    >
