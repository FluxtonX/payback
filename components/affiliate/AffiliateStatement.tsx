    ...
    <section className="font-sans">
      <div className="w-full max-w-[642px] min-[1366px]:max-w-[1000px] mx-auto px-4 md:px-6 my-16 md:my-20 min-[1366px]:my-24">
        <div className="flex flex-col items-center text-center">
          <h2 className="text-[#030e31] font-semibold text-[32px] leading-[40px] md:text-[40px] md:leading-[48px] mb-6 md:mb-8 text-center m-0">
            How To Get Started
          </h2>
          ...
          <p className="mt-2 text-[16px] leading-[24px] text-center m-0">
            <a
              ...
              className="text-[#030e31] font-medium underline hover:text-[#216ba5] transition-colors"
            >
