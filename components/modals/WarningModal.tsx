...
export const WarningModal: React.FC = () => {
  ...
  return (
    <div
      role="alert"
      className="fixed bottom-4 left-4 right-4 sm:right-auto sm:max-w-[420px] bg-white shadow-[0_-6px_32px_rgba(0,0,0,0.16)] p-4 z-[999] border border-[var(--brand-soft)] font-sans"
    >
      ...
      <div className="flex justify-end">
        <button
          ...
          className="border border-[var(--brand-primary)] px-6 py-1.5 text-[14px] font-medium text-[var(--brand-primary)] bg-white hover:bg-[var(--brand-primary)] hover:text-white transition-colors"
        >
