...
const data = servicesBatch82Data['adr-guidance'];

export const metadata: Metadata = {
  title: `${data.title} | Online Reclaims`,
  description: data.description,
  alternates: {
    canonical: 'https://onlinereclaims.com/adr-guidance/',
  },
  openGraph: {
    title: `${data.title} | Online Reclaims`,
    description: data.description,
    url: 'https://onlinereclaims.com/adr-guidance/',
...
export default function AdrGuidancePage() {
  return (
    <main className="bg-white min-h-screen">
      ...
      <ServiceProcessSteps
        title="How it works"
        subtitle="Resolve your disputes out of court through our structured Alternative Dispute Resolution guidance."
        steps={data.steps}
      />
