...
const data = servicesBatch84Data['security-consulting'];

export const metadata: Metadata = {
  title: `${data.title} | Online Reclaims`,
  description: data.description,
  alternates: {
    canonical: 'https://onlinereclaims.com/security-consulting/',
  },
  openGraph: {
    title: `${data.title} | Online Reclaims`,
    description: data.description,
    url: 'https://onlinereclaims.com/security-consulting/',
